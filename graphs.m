...
if exist('ceemdan', 'file') ~= 2
    warning('CEEMDAN function not found. Proceeding without decomposition.');
...
if exist('ceemdan', 'file') == 2
    ...
    % Display Correlation Matrices for All Nodes
    for i = 1:num_nodes
        figure;
...
%% ========== 7. Save Outputs ==========
save('simulation_results.mat', 'bus_data', 't', 'power_signals');
