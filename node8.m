...
%% ========== 1. Generate Power Time-Series Data for Node 8 ==========
...
title('Generated Power Signal for Node 8');
grid on;
pause(0.1);
...
sgtitle('IMF Decomposition (IMF 1-10) for Node 8');
...
colorbar;
title('Correlation Coefficients of EMD Components for Node 8');
...
title('Original vs Reconstructed Signal for Node 8');
legend;
grid on;
pause(0.1);
...
%% ========== 6. Save Outputs ==========
save('simulation_results_node8.mat', 'imf_matrix', 'correlation_matrix', 'reconstructed_signal', 'sample_index', 'power_signal');

disp('Simulation completed successfully. Results saved in "simulation_results_node8.mat".');
